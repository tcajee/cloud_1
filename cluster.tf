...
resource "google_container_cluster" "cluster" {
  ...
  # "default node pool" with that # of nodes. # So, we need to set an initial_node_count of 1.
  # This will make a default node pool with server-defined defaults that Terraform will immediately delete as part of Create.
  # This leaves us in our desired state- with a cluster master with no node pools.
  ...
  # We can optionally control access to the cluster See https://cloud.google.com/kubernetes-engine/docs/how-to/private-clusters
